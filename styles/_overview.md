# Styles Overview — Macro Map of Design Languages

This folder contains dense breakdowns of major graphic, product, and digital design styles. Each style folder follows a consistent structure:

1. Definition & historical context
2. Core visual characteristics / rules
3. Dos and Don’ts
4. Particularities & edge cases
5. How to achieve it (practical levers: color, type, layout, imagery, motion)
...
### Expressive / Reactionary
- `brutalism-neubrutalism/` — Raw, honest, anti-polish (web revival of architectural brutalism)
...
- `flat-design/` — Rejection of skeuomorphism; pure shapes, limited depth
- `material-design/` — Google’s system of depth, motion, and material metaphors
- `glassmorphism/` — Frosted glass, blur, transparency, soft depth
- `neomorphism/` — Soft extruded / inset forms (short-lived 2019–2021 trend)

### Other Notable
- `vaporwave-cyberpunk/` — Aesthetic internet subcultures with strong visual codes
- `luxury-minimal/` — High-end restraint with premium materials and spacing
